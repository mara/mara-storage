...
The following configuration values are used by this module. They are defined as python functions in ``mara_storage.config``
...
.. module:: mara_storage.config

.. autofunction:: storages
